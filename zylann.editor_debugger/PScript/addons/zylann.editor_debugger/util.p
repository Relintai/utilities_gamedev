...
static Node get_node_in_parents(Node node, Variant klass) {
	#klass: PScriptNativeClass
	#print(klass);
...
static bool is_in_edited_scene(Node node) {
	#                               .___.
	#           /)               ,-^     ^-. 
	#          //               /           \
	# .-------| |--------------/  __     __  \-------------------.__
	...
	Node vp = get_node_in_parents(node, Viewport);
